...
export const heroSlides: HeroSlide[] = [
  ...
  },
  {
    ...
    image: '/hero/homepage/shinhan-history-hq-ai.png',
    mobileImage: '/hero/homepage/shinhan-history-hq-ai.png',
  ...
  },
  {
    ...
    mobileImage: '/hero/homepage/vietnam-hanoi-network-ai.png',
    objectPosition: '50% 50%',
    mobileObjectPosition: '50% center',
    theme: 'deep-blue',
  },
...
const expertCareerHighlights: Record<string, string[]> = {
  조나현: [
    '수출입통관 관리 및 법률 자문 (소비재, 자동차부품, 기계전자 외 다수 기업)',
    '통관적법성 사전점검 컨설팅 (과학 및 정밀기기, 의료기기 기업 외 다수)',
    '과세전적부심사, 조세심판청구 조세불복 대리 (의류, 과학 및 정밀기기 기업)',
    '품목분류 컨설팅 (자동차부품 외 다수)',
    '수입요건 인증 컨설팅 (식품검역, 안전관리 대상 생활화학제품)',
    '외국인투자기업 관세감면 관련 자문 수행',
    '전력투자 및 상환채무 대상 관련 자문 수행',
    '미국 관세(적용 관세율, 원산지 판정 등) 관련 자문 수행',
  ],
  나지원: [
    '명품 및 글로벌 소비재 기업 관세 및 법률 자문',
    '석유화학설비 플랜트 건설 관련 과세가격 사전심사 컨설팅',
    '자동차 부품 AEO 종합심사 컨설팅 및 관세조사 대리 다수',
    'FTA 원산지 판정 및 시스템 구축 컨설팅',
    '품목분류 사전심사 다수',
    'AEO 공인인증 컨설팅 다수',
  ],
  서정용: [
    '수입식품 컨설팅(수입가능여부, 표시사항, 제출서류 등)',
    '수입식품 다수의 고객사 검역대행 (가공식품, 식품첨가물, 기구용기, 축산물, 건강기능식품)',
    '위생용품 검역신고 다수 진행',
    '축산물 검역신고 다수 진행 (지정검역물 등)',
    '식물검역 다수 진행 (검역대상물품, 검역제외가공품)',
    '식기, 헬멧, 자전거 등 KC 생활용품 안전인증대행',
    '양초, 세정제, 광택제 등 안전확인대상 생활화학제품 인증대행',
  ],
  이경심: [
    '수입식품 컨설팅(수입가능여부, 표시사항, 제출서류 등)',
    '수입식품 다수의 고객사 검역대행 (가공식품, 식품첨가물, 기구용기, 축산물, 건강기능식품)',
    '축산물 검역신고 다수 진행 (지정검역물 등)',
    '식물검역 다수 진행 (검역대상물품, 검역제외가공품)',
    '완제품, 원료제품 화장품 표준통관예정보고',
  ],
  오보람: [
    'D사 ACVA 대리',
    'S사, T사 관세조사 대리',
    'K사, V사 등 기계류, 전기기기 및 부분품 품목분류 사전심사 컨설팅 다수',
    'D사, F사, W사 등 글로벌 FTA 시스템 DB 구축 다수',
    '자동차 부품, 기계류 부품, 식품, 의류, 생활용품 등 FTA 원산지 판정 다수',
    '미국, 중국, 일본, 아세안 국가 등 주요 수출국 일반 비특혜 원산지 판정',
    '섬유, 의류, 자동차 부품, 동관 등 다수의 고객사 수출입 통관 적정성 검토 및 법률 자문',
  ],
  강민지: [
    '(베트남/일본/한국) FTA 시스템 구축 및 검증',
    '(미국/한국) 동관 물품 원계 및 검증',
    '위생용품, 자동차 부품, 의료용 기기 등 FTA 원산지 관리 다수',
    '위생용품, 화장품 등 인증수출자 인증 다수',
    '유아용품, 화장품, 카본블랙 등 수출입 통관',
    '의약품, 화이트카본 등 관세 환급',
  ],
  조석현: [
    'D사, F사 글로벌FTA HS, PSR DB 구축',
    'D사, P사 글로벌FTA HS 자문',
    'A사, G사 등 FTA 원산지관리 업무',
    'S사, T사 등 원산지인증수출자 인증',
  ],
  이하나: [
    '농, 축산물 검역 및 수출입 통관, 자동차 부품 등 수출입 통관',
    '관세조사 대리 다수',
    '조세불복 대리 다수',
    '농, 축산물, 자동차 부품, 제약, 공산품 등 다수의 고객사 수출입 통관 적정성 검토 및 법률 자문',
  ],
  조원희: [
    '전자기기, 플랜트설비 수출입통관',
    '관세조사 대리 다수',
    '외환검사 대리 다수',
    '자동차 부품 품목분류 컨설팅',
    '전자기기, 자동차 부품, 의료장비, 플랜트설비 등 다수의 고객사 수출입통관 적정성 검토 및 법률 자문',
  ],
  김유진: [
    '의약품, 바이오 장비 및 부품 등 수출입 통관',
    '납세신고도움서비스 자율점검 대리 다수',
    '산업용 장비 부품 품목분류 컨설팅',
    '의약품, 바이오 장비 및 부품, 자동차 부품, 의류, 전자기기 등 다수의 고객사 수출입 통관 적정성 검토 및 법률 자문',
  ],
  김정훈: [
    '명품, 사무기기 등 수출입 통관',
    '관세조사 대리 다수',
    '외환검사 대리 다수',
    '반도체 제조용 장비 품목분류 컨설팅',
    '섬유, 사무기기, 자동차 부품 등 다수의 고객사 수출입 통관 적정성 검토 및 법률 자문',
  ],
  신종호: [
    '베트남 정기, 비정기 세관조사 대응 10회 이상',
    '베트남 수책관리 자문 및 연간보고 대행 30개사 이상',
    'FTA 원산지관리 시스템 및 수책관리 시스템 구축: 20개사 이상',
    '통관 및 원산지증명서 발급, 품목분류 사전심사: 월간 500건 이상 통관 및 CO발급 진행, 품목분류 사전심사 30건 이상 수행',
    'FTA 원산지 관리시스템 및 관세 환급시스템 구축 및 수행업무 수행',
    '원산지 검증 대응 및 법인심사 업무 수행 다수',
    '무역 및 FTA 원산지 활용 등 교육 및 자문 활동 다수',
    '2017년 관세평가분류원 관세평가 연구논문 최우수상 - 관세청장 상장',
  ],
  김선웅: [
    'EVFTA, CPTPP, AJCEP 및 베트남 비특혜 원산지 판정 수행 (의류, 기계류, 철강 분야)',
    '수책 관리 및 원가공 계약 공장 세관등록 자문 수행 (제조업 전반)',
    'SAP / ERP 데이터 기반 수책 관리 및 GAP 분석 수행 (철강 분야)',
    'KORD FTA, KORD LIQ 구축, 분석 및 운영 지원 (전자부품, 자동차부품 분야)',
  ],
  홍성훈: [
    'ERP 운영 및 인터페이스 (신한 외)',
    'e-commerce 시스템 구축 (신한 외)',
    '온라인 반품 시스템 구축 (신한 외)',
    '세금계산서 발행 시스템 구축 (신한 외)',
    '베트남 FTA 및 수책관리시스템 구축',
    '한국 이음 및 이음 큐 구축',
    '고객사 인터페이스 구축',
  ],
};
...
const withCareerHighlights = (member: Member): Member => ({
  ...member,
  careerHighlights: expertCareerHighlights[member.name] ?? member.careerHighlights,
});
