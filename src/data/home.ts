...
export const heroSlides: HeroSlide[] = [
  ...
  },
  {
    ...
    headline: '1965년 창립한 신한의 풍부한 경험을 바탕으로\n깊이 있는 전문성을 제공합니다.',
  ...
  },
  {
    ...
    image: '/hero/homepage/vietnam-airport-network-ai.png',
    mobileImage: '/hero/homepage/vietnam-airport-network-ai.png',
    objectPosition: '50% 50%',
    mobileObjectPosition: '50% center',
    theme: 'deep-blue',
  },
  {
    ...
    headline: '물류의 흐름이 멈추지 않도록,\n철저한 법령 검토로 수출입의 길을 밝힙니다.',
...
const expertPracticeAreas: Record<string, string[]> = {
  ...
  신종호: [
    ...
    '원산지 및 FTA 원산지관리 이슈·제도 자문',
    '베트남 Liquidation 및 FTA 원산지관리 시스템 개발·설치·구독 서비스 제공',
    '스케줄 관리',
    '통관 및 수출입 무역거래 자문',
    'Post Inspection 조력',
  ],
  김선웅: [
    'FTA 원산지 판정 및 베트남 FTA 활용 컨설팅',
    '수책관리 컨설팅 및 회계세관 자문',
    '베트남 FTA 시스템 및 수책관리 시스템 구축·분석·운영',
    '베트남 통관 적법성 검토 및 무역거래 자문',
  ],
  김다혜: [
