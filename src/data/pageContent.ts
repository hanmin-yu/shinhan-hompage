...
export const aboutTimeline = [
  { period: '2011-current', year: '2025', event: '03월 신한관세법인 창립 60주년', eventEn: 'Mar. 60th anniversary of Shinhan Customs Service' },
  { period: '2011-current', year: '2023', event: '01월 신한관세법인 AEO 공인인증 AA 인증', eventEn: 'Jan. Shinhan Customs Service received AEO AA certification' },
  { period: '2011-current', year: '2021', event: '08월 관세청 적극행정 및 규제혁신 대국민 공모전 입상', eventEn: 'Aug. Awarded in the Korea Customs Service public contest for proactive administration and regulatory innovation' },
  { period: '2011-current', year: '2021', event: '03월 2018~2021년 수출바우처 컨설팅 수행기관 선정', eventEn: 'Mar. Selected as an export voucher consulting provider for 2018-2021' },
  { period: '2011-current', year: '2019', event: '03월 신한 베트남 관세법인(SCV) 설립(현지 컨설팅·통관업무)', eventEn: 'Mar. Established Shinhan Customs Vietnam (SCV) for local consulting and clearance services' },
  { period: '2011-current', year: '2019', event: '01월 관세청 YES FTA 전문교육기관 선정', eventEn: 'Jan. Selected as a Korea Customs Service YES FTA professional training institution' },
  { period: '2011-current', year: '2018', event: '09월 관세청 블록체인 기반 수출통관 물류서비스 시범사업 업무협약 체결', eventEn: 'Sep. Signed an MOU for the Korea Customs Service blockchain-based export clearance logistics pilot project' },
  { period: '2011-current', year: '2018', event: '05월 K-V FTA 활용역량강화 경제협력사업 베트남 현지 포럼 개최', eventEn: 'May Hosted a Vietnam forum for the K-V FTA utilization capacity-building economic cooperation project' },
  { period: '2011-current', year: '2018', event: '01월 관세청 YES FTA 전문교육기관 선정', eventEn: 'Jan. Selected as a Korea Customs Service YES FTA professional training institution' },
  { period: '2011-current', year: '2017', event: '04월 포스트차이나 베트남 진출 기업 대상 관세통관제도 설명회 개최', eventEn: 'Apr. Held a customs clearance system seminar for companies entering post-China Vietnam markets' },
  { period: '2011-current', year: '2017', event: '03월 대전충남지사 설립', eventEn: 'Mar. Established the Daejeon-Chungnam Branch' },
  { period: '2011-current', year: '2017', event: '01월 K-V FTA 활용 역량강화사업 연구', eventEn: 'Jan. Conducted research for the K-V FTA utilization capacity-building project' },
  { period: '2011-current', year: '2017', event: '01월 관세청 YES FTA 전문교육기관 선정', eventEn: 'Jan. Selected as a Korea Customs Service YES FTA professional training institution' },
  { period: '2011-current', year: '2016', event: '09월 한국관세사회 공로패', eventEn: 'Sep. Received a merit plaque from the Korea Customs Brokers Association' },
  { period: '2011-current', year: '2016', event: '01월 KORD Partners Inc. 설립(미국 LA 통관/FDA 요건 컨설팅)', eventEn: 'Jan. Established KORD Partners Inc. for US LA clearance and FDA requirements consulting' },
  { period: '2011-current', year: '2016', event: '01월 중소기업진흥공단 관세법인 활용 FTA 교육', eventEn: 'Jan. Provided FTA training using customs corporation expertise for the Small and Medium Business Corporation' },
  { period: '2011-current', year: '2015', event: '03월 신한관세법인 창립 50주년', eventEn: 'Mar. 50th anniversary of Shinhan Customs Service' },
  { period: '2011-current', year: '2015', event: '01월 KOTRA 한중 FTA 이해·활용전략 포럼 감사패 수상', eventEn: 'Jan. Received an appreciation plaque at KOTRA Korea-China FTA understanding and utilization strategy forum' },
  { period: '2011-current', year: '2015', event: '01월 포워딩 G사 고객사 우수협력상 표창', eventEn: 'Jan. Received an outstanding partner award from forwarding company G' },
  { period: '2011-current', year: '2015', event: '01월 글로벌 I사 고객사 우수협력상 표창', eventEn: 'Jan. Received an outstanding partner award from global company I' },
  { period: '2011-current', year: '2014', event: '05월 구미지사 설립', eventEn: 'May Established the Gumi Branch' },
  { period: '2011-current', year: '2014', event: '04월 미국 법률·회계 JC&COMPANY MOU 체결', eventEn: 'Apr. Signed an MOU with US legal and accounting firm JC&COMPANY' },
  { period: '2011-current', year: '2014', event: '03월 무역협회 OK FTA 컨설팅 수행', eventEn: 'Mar. Performed OK FTA consulting for the Korea International Trade Association' },
  { period: '2011-current', year: '2014', event: '01월 FTA 중소기업지원 우수사례 최우수상 수상', eventEn: 'Jan. Won the grand prize for best SME support case in FTA utilization' },
  { period: '2011-current', year: '2013', event: '05월 중소기업진흥공단 관세법인 활용 FTA 교육', eventEn: 'May Provided FTA training using customs corporation expertise for the Small and Medium Business Corporation' },
  { period: '2011-current', year: '2013', event: '03월 인도 PMP LOGISTICS MOU 체결', eventEn: 'Mar. Signed an MOU with PMP LOGISTICS in India' },
  { period: '2011-current', year: '2013', event: '01월 신한관세법인 AEO 공인인증 AA 인증', eventEn: 'Jan. Shinhan Customs Service received AEO AA certification' },
  { period: '2011-current', year: '2012', event: '08월 AEO 우수사례 경진대회 본상 수상', eventEn: 'Aug. Received a main award at the AEO best practices competition' },
  { period: '2011-current', year: '2012', event: '03월 무역협회 OK FTA 컨설팅 수행', eventEn: 'Mar. Performed OK FTA consulting for the Korea International Trade Association' },
  { period: '2011-current', year: '2011', event: '11월 글로벌 I사 고객사 우수협력사 감사패 수상', eventEn: 'Nov. Received an outstanding partner appreciation plaque from global company I' },
  { period: '2011-current', year: '2011', event: '01월 ECCK Official Customs Advisor', eventEn: 'Jan. Appointed as ECCK Official Customs Advisor' },
  { period: '2011-current', year: '2011', event: '01월 중소기업진흥공단 FTA 컨설팅 기관', eventEn: 'Jan. Designated as an FTA consulting institution for the Small and Medium Business Corporation' },
  { period: '2001-2010', year: '2010', event: '01월 포워딩 B사 고객사 우수협력사 감사패 수상', eventEn: 'Jan. Received an outstanding partner appreciation plaque from forwarding company B' },
  { period: '2001-2010', year: '2010', event: '01월 관세법인 최초 AEO 인증 획득', eventEn: 'Jan. Became the first customs corporation to obtain AEO certification' },
  { period: '2001-2010', year: '2010', event: '01월 신한인비스타 보세창고 설립', eventEn: 'Jan. Established Shinhan Invista bonded warehouse' },
  { period: '2001-2010', year: '2008', event: '08월 FTA BUSINESS MODEL 경진대회 최우수상', eventEn: 'Aug. Won the grand prize at the FTA Business Model competition' },
  { period: '2001-2010', year: '2007', event: '08월 청주지사 설립', eventEn: 'Aug. Established the Cheongju Branch' },
  { period: '2001-2010', year: '2007', event: '02월 인천경기지사 설립', eventEn: 'Feb. Established the Incheon-Gyeonggi Branch' },
  { period: '2001-2010', year: '2007', event: '01월 신한인비스타 설립', eventEn: 'Jan. Established Shinhan Invista' },
  { period: '2001-2010', year: '2006', event: '02월 글로벌 I사 고객사 우수협력사 감사패 수상', eventEn: 'Feb. Received an outstanding partner appreciation plaque from global company I' },
  { period: '2001-2010', year: '2006', event: '01월 부산지사 설립', eventEn: 'Jan. Established the Busan Branch' },
  { period: '2001-2010', year: '2006', event: '01월 컨설팅본부 설립', eventEn: 'Jan. Established the Consulting Division' },
  { period: '2001-2010', year: '2004', event: '01월 인천공항지사 설립', eventEn: 'Jan. Established the Incheon Airport Branch' },
  { period: '1965-2000', year: '1993', event: '03월 신한관세법인 법인 등록', eventEn: 'Mar. Registered Shinhan Customs Service as a corporation' },
  { period: '1965-2000', year: '1982', event: '01월 장흥진 회장 한국관세사회 부회장 역임', eventEn: 'Jan. Chairman Jang Heung-jin served as vice president of the Korea Customs Brokers Association' },
  { period: '1965-2000', year: '1977', event: '05월 장흥진 회장 사단법인 한국관세협회 상임이사 역임', eventEn: 'May Chairman Jang Heung-jin served as executive director of the Korea Customs Association' },
  { period: '1965-2000', year: '1977', event: '01월 장흥진 회장 한국관세사회 서울지부 초대 지부장 역임', eventEn: 'Jan. Chairman Jang Heung-jin served as the first head of the Seoul branch of the Korea Customs Brokers Association' },
  { period: '1965-2000', year: '1965', event: '03월 서울통관사 창립', eventEn: 'Mar. Founded as Seoul Customs Service' },
];
...
const customsAuditSections: ServiceDetailSection[] = [
  ...
  },
  {
    ...
    body: ['과세가격, 품목분류, 통관요건, 환급, 감면, 원산지, 보세화물관리, 외국환거래 등 주요 조사 분야를 포함한 전 분야 업무를 지원합니다.'],
    list: [
      '과세가격: 거래가격과 가산·공제 요소의 적정성을 점검합니다.',
      '품목분류: HS CODE 정합성과 세율 적용 리스크를 검토합니다.',
      '통관요건: 인증·허가·표시 기준 등 수입 요건을 점검합니다.',
      '환급: 환급 산정과 증빙 적정성을 확인합니다.',
      '감면: 감면 요건 충족 여부와 사후관리 리스크를 점검합니다.',
      '원산지: 원산지 또는 협정관세 적용 및 증명서류에 관한 사항의 적법성을 검토합니다.',
      '보세화물관리: 보세구역 반출입과 재고 관리 적정성을 확인합니다.',
...
const customsAuditImages: ServiceDocumentImage[] = [
  {
    ...
    alt: '관세조사 주요 조사 분야',
    caption: '과세가격, 품목분류, 통관요건, 환급, 감면, 원산지, 보세화물관리, 외국환거래 등 관세조사 주요 쟁점을 한눈에 보여주는 자료입니다.',
  },
];
...
const usFdaSections: ServiceDetailSection[] = [
  {
    ...
    headingEn: 'Key Services',
    list: [
      '미국 현지 업무 대행: 미국 캘리포니아에 본사를 두어 현지 최신정보를 활용한 맞춤형 조언',
      '시차 없는 컨설팅: 컨설팅 도중 궁금하신 사항에 대해 한국 FDA 전문가의 빠르고 정확한 가이드',
      '국내외 대기업 다수 컨설팅 중: 식품 및 화장품 국내외 다수 대기업의 미국 현지 시장 진출에 도움',
    ],
  },
  {
    heading: '주요 서비스 상세',
    headingEn: 'Key Service Details',
    body: [
      '미국수출에 필요한 통관 전 검토사항 및 미국 수출 관련 규제 준수와 관계를 통해 검역·통관 및 관련 컨설팅을 진행합니다. 뿐만 아니라 미국 현지 유통 채널별 규정 준수 및 제조공장 인허가 컨설팅까지 진행하고 있습니다.',
    ],
    list: [
      '통관사전검토|수출 적합성 검토(원료 검토)',
      '통관사전검토|HTS Code 분류',
      '통관사전검토|수출입 통관 관세사 연결',
      '미국 규제 준수 컨설팅|미국 수입 적합성 검토(원료 검토)',
      '미국 규제 준수 컨설팅|라벨링/문안 검토 및 영양성분표 시안 제작',
      '미국 규제 준수 컨설팅|FDA 공장등록(FFR/DUNS)',
      '미국 규제 준수 컨설팅|FCE/SID Filing',
      '미국 규제 준수 컨설팅|FSVP',
      '미국 규제 준수 컨설팅|Structure/function claim',
      '미국 규제 준수 컨설팅|NDI(New Dietary Ingredient)',
      '미국 규제 준수 컨설팅|Food safety plan/HACCP 검토',
      '미국 규제 준수 컨설팅|Permit',
      '리스크 제어/경쟁력|상세페이지 검수',
      '리스크 제어/경쟁력|FDA 수입경보 해제',
      '리스크 제어/경쟁력|FDA/USDA 제조공장 인허가',
      '리스크 제어/경쟁력|미국 유통채널별 규정준수',
      '리스크 제어/경쟁력|California Prop 65',
      '리스크 제어/경쟁력|위생 설계 검토(Sanitary design Review)',
      '리스크 제어/경쟁력|GFSI/Organic/Non GMO/Kosher 인증',
      '리스크 제어/경쟁력|Co-packer/Supplier assessment',
      '리스크 제어/경쟁력|현지 마켓 플레이스별 규정 준수',
    ],
  },
  {
    heading: '특장점',
    ...
    contentSections: [
      {
        ...
        headingEn: 'Key Services',
        list: [
          'Warehouse Task|보세화물 입출고 관리',
          'Warehouse Task|일반화물 입출고 관리',
          'Warehouse Task|3PL 관리업무',
          'Warehouse Task|화물 장-단기 보관',
          'Warehouse Task|AEO 절차관리',
          'Forwarding|항공 해상 수출입 CARGO HANDLING',
          'Forwarding|LCL 화물 정기 CONSOLIDATION',
          'Forwarding|SEA & AIR 복합운송',
          'Forwarding|DOOR TO DOOR',
          'Forwarding|벌크, 특수화물, 위험물 운송',
          'Forwarding|창고보관 및 내륙운송',
          'Trucking|수출입 연계 수배송 서비스',
          'Trucking|보세운송 서비스',
          'Trucking|일반 수배송',
          'Trucking|반품회수',
          'Trucking|PACKING, SHORING',
        ],
      },
    ],
    contactPoints: [
